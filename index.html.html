...
<body>
  ...
  <div class="container">
    <header class="center">
      ...
      <p class="lead">Walau kita lagi LDR, semoga halaman kecil ini bikin kamu merasa dipeluk dari jauh ya cantik — Rizki</p>
      <br />
    ...
    <section id="quiz" class="card hidden" style="margin-top:16px">
      ...
      <div class="quiz">
        <p><q>Kapan tanggal kira jadian?</q></p>
        <label class="opt"><input type="radio" name="q1" value="correct"> 16 Januari</label>
        <label class="opt"><input type="radio" name="q1" value="wrong"> 27 Februari</label>
        <label class="opt"><input type="radio" name="q1" value="wrong"> 22 Agustus</label>
        <p><q>Makanan favorit kamu yang sering kita bahas?</q></p>
        <label class="opt"><input type="radio" name="q2" value="wrong"> Mie ayam</label>
        <label class="opt"><input type="radio" name="q2" value="correct"> Sushi</label>
        <label class="opt"><input type="radio" name="q2" value="wrong"> Pizza</label>
        <p><q>Destinasi impian aku?</q></p>
    ...
    <section id="final" class="card hidden" style="margin-top:16px">
      <h2>Untuk Penutup… ✨</h2>
      <p>Semoga di tahun ini penuh hal-hal manis, rezeki yang lancar, dan langkah yang makin dekat sama mimpi-mimpi kamu. Terima kasih sudah jadi rumah paling hangat buat aku. I love you more. 💌</p>
    </section>

    <footer>
      <small class="note">Made with 💗 by rizqyphp 😉</small>
    </footer>
  </div>
  ...
  <script>
    ...
    // Typewriter text
    const text = `Selamat ulang tahun, sayangku!\n\nTerimakasih ya cantik sudah bertahan sampai sekarang sampai kamu bisa masuk kedalam hidup aku, aku sampai saat ini selalu bangga atas semua pencapaian kamu, semua hal tentang kamu tapi kalau ada sifat buruk kamu yang harus dirubah demi masa depan kamu aku mohon buat belajar bareng bareng ya buat jadi pribadi yang lebih baik lagi. Aku sebenernya gatau mau ngomong apalagi tapi pastinya aku minta maaf belum bisa nmenin kmu langsung kesana dihari spesial ini, maaf juga aku belum bisa ngasih apa apa ke kamu. Doa aku buat kamu semoga kamu dan keluarga dikasih kesehatan, rezekinya dilancarkan, semoga jalan yang kamu ambil dipermudah ya sayang.\n\nSemoga kamu selalu bisa ada untuk aku pulang ya sayang. ❤️`;
